        ...
        () => NavigationBar(
            ...
            destinations: const [
              NavigationDestination(
                  icon: Icon(Iconsax.home_1_bold), label: 'Home'),
              NavigationDestination(
                  icon: Icon(Iconsax.shop_bold), label: 'Store'),
              NavigationDestination(
                  icon: Icon(Iconsax.heart_bold), label: 'Wishlist'),
              NavigationDestination(
                  icon: Icon(Iconsax.user_bold), label: 'Profile'),
            ]),
      ),

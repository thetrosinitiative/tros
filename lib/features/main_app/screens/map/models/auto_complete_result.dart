...
class AutoCompleteResult {
  ...
  factory AutoCompleteResult.fromMap(Map<String, dynamic> map) {
    return AutoCompleteResult(
      ...
      types: map['types'] != null
          ? List<Terms>.from(map['types']?.map((x) => Terms.fromMap(x)))
          : null,
    );
  }
  ...
  @override
  String toString() {
    return 'AutoCompleteResult(description: $description, matchedSubStings: $matchedSubStings, placeId: $placeId, reference: $reference, structuredFormatting: $structuredFormatting, terms: $terms, types: $types)';
  }
